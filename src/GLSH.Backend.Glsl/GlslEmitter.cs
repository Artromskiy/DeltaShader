...
public static class GlslEmitter
{
    public static GlslEmitResult EmitFromModule(ShaderIrModule module)
    {
        ...
        foreach (var resource in module.Resources)
        {
            ...
            var resourceName = identifiers.Mangle(resource.Name, "resource");
            ...
            {
                identifierMap[resource.Name] = resourceName;
                identifierMap[$"{resource.Name}.data"] = $"{resourceName}.{dataMemberName}";
            }
        }
