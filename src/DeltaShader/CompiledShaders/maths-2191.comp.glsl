...
mat4 delta_quaternionToMatrix(vec4 rotation) { return delta_createFromQuaternion(rotation); }
...
void main()
{
    ...
    {return;}
    mat4 local_result = delta_quaternionToMatrix(Input0_instance.data[local_index]);
