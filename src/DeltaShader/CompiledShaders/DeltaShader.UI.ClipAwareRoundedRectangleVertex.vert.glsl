#version 460
struct DeltaStruct_Delta_Shader_UI_ClipAwareRoundedRectangleParameters
{
    vec4 member_Rect;
...
{
    DeltaStruct_Delta_Shader_UI_ClipAwareRoundedRectangleParameters data[];
} Instances_instance;
...
void main()
{
    DeltaStruct_Delta_Shader_UI_ClipAwareRoundedRectangleParameters instance = Instances_instance.data[gl_InstanceIndex];
