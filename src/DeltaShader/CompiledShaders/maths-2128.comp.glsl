...
vec3 delta_transformDirection(mat4 matrix, vec3 direction) { return (matrix * vec4(direction, 0.0)).xyz; }
...
void main()
{
    ...
    {return;}
    vec3 local_result = delta_transformDirection(Input0_instance.data[local_index], Input1_instance.data_0[local_index]);
