...
vec4 delta_quaternionNormalize(vec4 value) { return value / sqrt(dot(value, value)); }
...
void main()
{
    ...
    {return;}
    vec4 local_result = delta_quaternionNormalize(Input0_instance.data[local_index]);
