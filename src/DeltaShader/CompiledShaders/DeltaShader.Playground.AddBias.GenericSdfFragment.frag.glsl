...
void main()
{
    ...
    DeltaStruct_Delta_Shader_Playground_Raymarcher_Delta_Shader_Playground_ModifiedShape_Delta_Shader_Playground_SpaceTwist__Delta_Shader_Playground_ModifiedShape_Delta_Shader_Playground_SpaceInfRepeat__Delta_Shader_Playground_SdfBox___ pipeline =
    DeltaStruct_Delta_Shader_Playground_Raymarcher_Delta_Shader_Playground_ModifiedShape_Delta_Shader_Playground_SpaceTwist__Delta_Shader_Playground_ModifiedShape_Delta_Shader_Playground_SpaceInfRepeat__Delta_Shader_Playground_SdfBox___(twistedScene);
