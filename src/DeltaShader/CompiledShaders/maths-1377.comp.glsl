...
void main()
{
    ...
    {return;}
    uint local_result = bitfieldInsert(Input0_instance.data[local_index], Input1_instance.data_0[local_index], Input2_instance.data_1[local_index], Input3_instance.data_2[local_index]);
