...
layout(set = 0, binding = 3, std430) buffer Out0
{
    uvec3 data_2[];
} Out0_instance;
...
void main()
{
    ...
    {return;}
    ;
    uvec3 local_result = usubBorrow(Input0_instance.data[local_index], Input1_instance.data_0[local_index], local_out0);
    Output_instance.data_1[local_index] = local_result;
    Out0_instance.data_2[local_index] = local_out0;
