...
layout(set = 0, binding = 0) readonly buffer InA { vec4 _d0[]; } inputA;
layout(set = 0, binding = 1) readonly buffer InB { vec4 _d1[]; } inputB;
layout(set = 0, binding = 2) writeonly buffer Out { vec4 _d2[]; } output;
void Add() { }
```
