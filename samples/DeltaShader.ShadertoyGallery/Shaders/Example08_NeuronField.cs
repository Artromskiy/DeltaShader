...
{
    [FragmentShader]
    public static float4 NeuronField(in GalleryFragmentContext context, in GalleryVarying input)
    {
        ...
        {
            var phase = i * 1.73f + context.Constants.Time * (0.6f + i * 0.08f);
        ...
        return new float4(0.02f + 0.8f * pulse, 0.06f + 0.25f * connections, 0.12f + 0.9f * connections, 1f);
    }
}
