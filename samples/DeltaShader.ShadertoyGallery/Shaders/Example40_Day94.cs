...
{
    [FragmentShader]
    public static float4 Day94(in GalleryFragmentContext context, in GalleryVarying input)
    {
        ...
        var color = new float4(0.03f + corona * 0.42f + sun * 0.45f, 0.05f + corona * 0.25f + sun * 0.4f, 0.12f + corona * 0.08f + sun * 0.18f, 1f);
