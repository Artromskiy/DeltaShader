...
{
    [FragmentShader]
    public static float4 GlassBubble(in GalleryFragmentContext context, in GalleryVarying input)
    {
        ...
        return new float4(0.04f + rim * 0.45f + highlight, 0.16f + body * 0.22f + rim * 0.5f, 0.22f + body * 0.65f + highlight * 0.6f, 1f);
    }
}
