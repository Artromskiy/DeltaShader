...
{
    [FragmentShader]
    public static float4 SpaghettiCurves(in GalleryFragmentContext context)
    {
        ...
        {
            var phase = strand * 2.1f + context.Constants.Time;
        ...
        return new float4(glow.x, glow.y, glow.z, 1f);
    }
}
