...
{
    [FragmentShader]
    public static void FractalLand(
        ...
        [FragmentColor] out float4 color)
    {
        ...
        {
            terrain += amplitude * maths.sin(p.x * frequency + octave * 1.7f + constants.Time * 0.12f) * (0.5f + 0.5f * maths.cos(p.x * frequency * 0.37f));
        ...
        color = new float4(0.04f + land * 0.16f + snow * 0.14f, 0.1f + land * 0.2f + snow * 0.22f, 0.22f + (1f - land) * 0.42f + snow * 0.26f, 1f);
    }
}
