...
internal static class Example46_SimpleRefractionTest
{
        ...
        [FragmentColor] out float4 color)
    {
        ...
        var refracted = p + normalProxy * (0.12f + 0.06f * maths.sin(constants.Time));
        ...
        color = new float4(0.025f + layerA * 0.11f + interfaceGlow * 0.18f, 0.08f + layerB * 0.28f + interfaceGlow * 0.32f, 0.18f + (layerA + layerB) * 0.24f + bubble * 0.18f, 1f);
    }
}
