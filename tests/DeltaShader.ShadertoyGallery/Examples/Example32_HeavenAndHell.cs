...
internal static class Example32_HeavenAndHell
{
    ...
    public static float4 HeavenAndHell(in GalleryFragmentContext context)
    {
        ...
        return new float4(0.08f * heaven + (0.35f + embers * 0.25f) * hell + seam * 0.85f, 0.18f * heaven + (0.035f + embers * 0.08f) * hell + seam * 0.35f, 0.36f * heaven + (0.015f + embers * 0.02f) * hell + seam * 0.05f, 1f);
