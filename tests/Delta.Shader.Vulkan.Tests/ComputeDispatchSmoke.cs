...
public sealed class ComputeDispatchSmoke
{
    ...
    private static string FindRepositoryRoot()
    {
        ...
        throw new DirectoryNotFoundException("Unable to locate Delta.Shader repository root.");
    }
    ...
    private static async Task<VulkanComputeDevice> CreateComputeDeviceOrSkip()
    {
        ...
        {
            throw SkipException.ForSkip($"Skip: unable to initialize Delta.Render Vulkan device. {ex.Message}");
        }
    }
    ...
    private sealed class VulkanRuntimeFactAttribute : FactAttribute
    {
        public VulkanRuntimeFactAttribute()
        {
            ...
            {
                Skip = "Requires a loadable MoltenVK runtime (libMoltenVK.dylib) for Delta.Render Vulkan dispatch.";
            }
        }
